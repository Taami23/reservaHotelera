...
public class reservaStepDefs {
    ...
    public void me_aseguro_que_los_campos_tengan_datos_correctos_y_obtengo_el_estado(String estado) {
        ...
        public void existe_un_cliente_id_nombre_rut_fecha_naci_telefono_email_contrasena(Integer id, String nombre, String rut, String fechaNac, String telefono, String email, String contrasena) throws ParseException, ClienteAlreadyExistsException, ClienteNotFoundException, ClienteNotFoundException, ClienteAlreadyExistsException {
